...
import org.xnatural.enet.modules.mvc.anno.Route;
 ...
 * mvc 模块
 */
public class MVCServer extends ServerTpl {
    ...
    /**
     * 服务启动后自动扫描此类所在包下的 Handler({@link org.xnatural.enet.modules.mvc.anno.Route} 注解的类)
     * @param clz
     */
    public MVCServer scan(Class clz) {
    ...
    /**
     * 收集 {@link #scan} 类对的包下边所有的 有注解{@link org.xnatural.enet.modules.mvc.anno.Route}的类
     */
    ...
    public MVCServer resolveHandler(Object source) {
